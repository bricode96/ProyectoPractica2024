            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a onclick="cargarContenido('content-wrapper','vistas/modulos/Guardado.php')" class="nav-link" style="cursor: pointer;">
                                <i class="fas fa-video nav-icon"></i>
                                <p>Guardado</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a onclick="cargarContenido('content-wrapper','vistas/modulos/citatorio.php')" class="nav-link" style="cursor: pointer;">
                                <i class="fas fa-video nav-icon"></i>
                                <p>citatorio</p>
                            </a>
                        </li>
