<?php
class ControladorUltrasonido {
    static public function ctrVerTabla() {
        $respuesta = ModeloUltrasonido::mdlMostrarTabla();
        return $respuesta;
    }

    static public function ctrRegistrarTabla($nombre, $identidad, $examen, $fecha, $estado, $departamento, $creacion, $identificador) {
        $respuesta = ModeloUltrasonido::mdlRegistrarTabla($nombre, $identidad, $examen, $fecha, $estado, $departamento, $creacion, $identificador);
        return $respuesta;
    }

    static public function ctrCreacionCambio($id, $creacion) {
        $respuesta = ModeloUltrasonido::mdlCreacionCambio($id, $creacion);
        return $respuesta;
    }

    static public function ctrCambioEstado($id, $estado) {
        $respuesta = ModeloUltrasonido::mdlEstadoCambio($id, $estado);
        return $respuesta;
    }
    ...
    static public function ctrActualizarDiferenciaEstado1($id) {
        $respuesta = ModeloUltrasonido::mdlActualizarDiferenciaEstado1($id);
        return $respuesta;
    }
    ...
    static public function ctrActualizarDiferenciaEstado2($id) {
        $respuesta = ModeloUltrasonido::mdlActualizarDiferenciaEstado2($id);
        return $respuesta;
    }

    static public function ctrActualizarPacienteDatos($id, $nombre, $identidad, $examen) {
        $respuesta = ModeloUltrasonido::mdlPacienteDatosActualizados($id, $nombre, $identidad, $examen);
        return $respuesta;
    }

    static public function ctrGuardarFechaEspera($id, $fechaespera) {
        $respuesta = ModeloUltrasonido::mdlGuardarFechaEspera($id, $fechaespera);
        return $respuesta;
    }

    static public function ctrGuardarFechaFinal($id, $fechafinal) {
        $respuesta = ModeloUltrasonido::mdlGuardarFechaFinal($id, $fechafinal); // Corregido: llamando a mdlGuardarFechaFinal
        return $respuesta;
    }
}
?>
