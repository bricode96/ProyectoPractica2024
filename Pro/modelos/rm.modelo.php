...
class ModeloResonanciaMagnetica {
    ...
    static public function mdlRegistrarTabla($nombre, $identidad, $fecha, $estado, $departamento, $examen, $creacion, $identificador) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO resonancia_magnetica(nombrerm, identidadrm, fecharm, estado, departamentorm, examenrm, creacion, identificadorrm) VALUES (:nombrerm, :identidadrm, :fecharm, :estado, :departamentorm, :examenrm, :creacion, :identificadorrm)");
        ...
        $stmt->bindParam(":identificadorrm", $identificador, PDO::PARAM_STR);
