...
class ModeloTomografiaCompu {
    ...
    static public function mdlRegistrarTabla($nombre, $identidad, $fecha, $estado, $departamento, $examen, $creacion, $identificador) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO tomografia_computarizada(nombretc, identidadtc, fechatc, estado, departamentotc, examentc, creacion, identificadortc) VALUES (:nombretc, :identidadtc, :fechatc, :estado, :departamentotc, :examentc, :creacion, :identificadortc)");
        ...
        $stmt->bindParam(":identificadortc", $identificador, PDO::PARAM_STR);
