...
class ModeloRayosX {
    ...
    static public function mdlRegistrarTabla($nombre, $identidad, $fecha, $estado, $departamento, $examen, $creacion, $identificador) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO rayosx(nombrerx, identidadrx, fecharx, estado, departamentorx, examenrx, creacion, identificadorrx) VALUES (:nombrerx, :identidadrx, :fecharx, :estado, :departamentorx, :examenrx, :creacion, :identificadorrx)");
        ...
        $stmt->bindParam(":identificadorrx", $identificador, PDO::PARAM_STR);
