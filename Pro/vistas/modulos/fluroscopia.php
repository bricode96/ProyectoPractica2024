...
<!-- Modal de Fluoroscopia -->
<div class="modal fade" id="modal-actualizar-fluroscopia">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <!-- encabezado de modal -->
            <div class="modal-header bg-info">
                <h4 class="modal-title">Pacientes de Fluoroscopia</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input type="hidden" id="idfluoroscopia" name="fluoroscopia" value="">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input class="form-control" type="hidden" name="identificador" id="txtIdentificador" value="FL" readonly>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        swal.fire({
                            ...
                            if (resultado.value) {
                                examenes.forEach(examen => {
                                    ...
                                    datos.append('fechafl', fechaFormateada);
                                    datos.append('estado', estado);
                                    datos.append('departamentofl', departamento);
                                    datos.append('creacion', creacion);
                                    datos.append('identificadorfl', identificador);
