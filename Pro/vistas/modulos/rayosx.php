        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input class="form-control" type="hidden" name="identificador" id="txtIdentificador" value="RX" readonly>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    swal.fire({
                        ...
                        if (resultado.value) {
                            examenes.forEach(examen => {
                                ...
                                datos.append('identificadorrx',identificador);
