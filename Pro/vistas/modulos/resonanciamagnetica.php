...
<!-- Modal de Resonancia Magnética -->
<div class="modal fade" id="modal-actualizar-rm">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <!-- encabezado de modal -->
            <div class="modal-header bg-info">
                <h4 class="modal-title">Pacientes de Resonancia Magnética</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input class="form-control" type="hidden" name="identificador" id="txtIdentificador" value="RM" readonly>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        swal.fire({
                            ...
                            if (resultado.value) {
                                examenes.forEach(examen => {
                                    ...
                                    datos.append('identificadorrm', identificador);
                                ...
                                $("#txtDepartamento").val("Resonancia Magnética");
                                $("#dleExamen").val("0");
                                $("#txtCreacion").val("1");
                                $("txtIdentificador").val("RM");
