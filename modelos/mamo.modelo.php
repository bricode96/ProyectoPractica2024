...
class ModeloMamografia {
    ...
    static public function mdlRegistrarTabla($nombre, $identidad, $fecha, $estado, $departamento, $examen, $creacion) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO mamografia(nombremm, identidadmm, fechamm, estado, departamentomm, examenmm, creacion) VALUES (:nombremm, :identidadmm, :fechamm, :estado, :departamentomm, :examenmm, :creacion)");
