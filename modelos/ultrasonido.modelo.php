...
class ModeloUltrasonido {
    ...
    static public function mdlRegistrarTabla($nombre, $identidad, $fecha, $estado, $departamento, $examen, $creacion) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO ultrasonido(nombreul, identidadul, fechaul, estado, departamentoul, examenul, creacion) VALUES (:nombreul, :identidadul, :fechaul, :estado, :departamentoul, :examenul, :creacion)");
