...
class ModeloFluroscopia{
    ...
    static public function mdlRegistrarTabla($nombre, $identidad, $fecha, $estado, $departamento, $examen, $creacion) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO fluroscopia(nombrefl, identidadfl, fechafl, estado, departamentofl, examenfl, creacion) VALUES (:nombrefl, :identidadfl, :fechafl, :estado, :departamentofl, :examenfl, :creacion)");
